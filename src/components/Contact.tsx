...
const Contact = () => {
  ...
  return (
    <motion.section
      id="contact"
      className="py-20 bg-gradient-to-br from-teal-50 via-white to-blue-50 dark:from-teal-900/20 dark:via-gray-900 dark:to-blue-900/20 transition-colors duration-300"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-6 pb-2">
            Let's Work Together
          </h2>
          ...
          <div className="space-y-6 sm:space-y-8">
            <div>
              <h3 className="text-xl sm:text-2xl font-bold relative inline-block mb-6">
                ...
                <div className="absolute -bottom-2 left-0 w-full h-1 bg-teal-600 rounded-full"></div>
              </h3>
