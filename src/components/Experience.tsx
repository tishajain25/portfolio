    ...
    <section id="experience" className="py-20 bg-white dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-4 lg:left-1/2 top-0 bottom-0 w-0.5 bg-teal-600 transform lg:-translate-x-px"></div>
          ...
          {experiences.map((exp, index) => (
            <div key={index} className={`relative flex items-center mb-16 ${
              ...
              {/* Timeline Dot */}
              <div className="absolute left-4 lg:left-1/2 w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center transform lg:-translate-x-4 z-10">
                <div className="w-4 h-4 bg-white rounded-full"></div>
              </div>

              {/* Content */}
              <div className={`w-full lg:w-1/2 ml-16 lg:ml-0 ${
                index % 2 === 0 ? 'lg:pr-12' : 'lg:pl-12'
              }`}>
                <div className={`bg-gray-50 dark:bg-gray-800 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 ${
